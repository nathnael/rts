...
class SkillTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create skill_type" do
    assert_difference('SkillType.count') do
      post skill_types_url, params: { skill_type: { created_by: @skill_type.created_by, deleted_at: @skill_type.deleted_at, modified_by: @skill_type.modified_by, name: @skill_type.name } }
    end
  ...
  test "should update skill_type" do
    patch skill_type_url(@skill_type), params: { skill_type: { created_by: @skill_type.created_by, deleted_at: @skill_type.deleted_at, modified_by: @skill_type.modified_by, name: @skill_type.name } }
