...
class SkillsTest < ApplicationSystemTestCase
  ...
  test "creating a Skill" do
    ...
    fill_in "Created by", with: @skill.created_by
    fill_in "Deleted at", with: @skill.deleted_at
    fill_in "Modified by", with: @skill.modified_by
    fill_in "Name", with: @skill.name
    fill_in "Skill type", with: @skill.skill_type_id
