...
define(
  ...
  function() {
    return {
      ...
      'schema_diff.compare': '/schema_diff/compare/<int:trans_id>/<int:source_sid>/<int:source_did>/<int:target_sid>/<int:target_did>',
      ...
      'search_objects.search': '/search_objectssearch/<int:sid>/<int:did>',

      'search_objects.types': '/search_objectstypes/<int:sid>/<int:did>',
