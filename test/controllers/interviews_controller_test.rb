...
class InterviewsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create interview" do
    assert_difference('Interview.count') do
      post interviews_url, params: { interview: { created_by: @interview.created_by, deleted_at: @interview.deleted_at, modified_by: @interview.modified_by, name: @interview.name, position_id: @interview.position_id } }
    end
  ...
  test "should update interview" do
    patch interview_url(@interview), params: { interview: { created_by: @interview.created_by, deleted_at: @interview.deleted_at, modified_by: @interview.modified_by, name: @interview.name, position_id: @interview.position_id } }
