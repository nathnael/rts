...
class EmploymentTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employment_type" do
    assert_difference('EmploymentType.count') do
      post employment_types_url, params: { employment_type: { created_by: @employment_type.created_by, deleted_at: @employment_type.deleted_at, description: @employment_type.description, modified_by: @employment_type.modified_by, name: @employment_type.name } }
    end
  ...
  test "should update employment_type" do
    patch employment_type_url(@employment_type), params: { employment_type: { created_by: @employment_type.created_by, deleted_at: @employment_type.deleted_at, description: @employment_type.description, modified_by: @employment_type.modified_by, name: @employment_type.name } }
